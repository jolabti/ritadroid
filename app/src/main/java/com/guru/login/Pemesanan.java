...
public class Pemesanan extends AppCompatActivity {
    ...
    String url = "http://192.168.1.14/rjbanadmin/index.php/maincontroller/lihat_pesanan_user_json/rita@gmail.com";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Pemesanan.this, bku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Pemesanan.this, DetailActivity.class);
    ...
    public void parseJsonResponse(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                book.setKodeBan(jObject.getString("kd_ban"));
                book.setTotalharganya(jObject.getInt("total"));
                books.add(book);
            }
