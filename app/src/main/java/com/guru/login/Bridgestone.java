...
public class Bridgestone extends AppCompatActivity {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Bridgestone.this, bku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Bridgestone.this, DetailActivity.class);
