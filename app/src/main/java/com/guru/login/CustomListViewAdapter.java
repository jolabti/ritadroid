...
public class CustomListViewAdapter extends ArrayAdapter<Banku> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.name_ban.setText("Nama Produk :" + book.getNamaBan());
        holder.kode_ban.setText("Kode Ban :" + book.getKodeBan());
        holder.merk_ban.setText("Merk :" + book.getMerkBan());
        holder.harga_ban.setText("Harga:" + book.getHargaBan());
        holder.ukuran_ban.setText("Ukuran :" + book.getUkuranBan());
        holder.stok_ban.setText("Stok :" + String.valueOf(book.getStokBan()));
